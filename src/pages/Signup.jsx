      ...
      <div className="w-screen h-screen flex ">
        <div className="w-[68%] inline-flex ">
          ...
          <div className="ml-20 mt-8">
            <p className="font-semibold text-center text-4xl">SIGN UP</p>
            ...
            <input
                ...
                onBlur={(e) => e.target.setAttribute("placeholder", "Name")} // Restore placeholder on blur
              ...
              <input
                ...
                className="bg-[#E3E3E3] mt-8 pl-4 w-[36rem] h-16 rounded-xl font-medium text-2xl text-black placeholder:font-medium placeholder:text-2xl placeholder:text-black"
                placeholder="Email"
                autoComplete="off"
                required
              />
            ...
            <p className="mt-8 text-center font-medium text-2xl hover:cursor-pointer hover:underline" onClick={() => {navigate("/login")}}>
              Login
            </p>
          </div>  
        </div>
